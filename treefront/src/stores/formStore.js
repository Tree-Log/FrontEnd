...
export const useFormStore = defineStore("formData", () => {
    ...
    const passwordCheck = ref({ name: "passwordCheck", type: "password", placeholder: "비밀번호를 확인해주세요", message: "", color: "" });
  ...
  return { email, password, name, passwordCheck, setEmail, setPassword, setName, setPasswordCheck};
});